...
import fx3u        # PLC通信クラス（電文作成と送受信）
import camera      # カメラ制御・画像処理クラス
import socket
...
if __name__ == '__main__':
    ...
    #fx3u = fx3u.Fx3u(socket.gethostbyname(socket.gethostname()), 50000, 4096)#fx3u通信クラスをインスタンス化（ローカルホスト）
    fx3u = fx3u.Fx3u("192.168.1.250", 5000, 4096)#fx3u通信クラスをインスタンス化（実機/仮想PLCのIPアドレス）
